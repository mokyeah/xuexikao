...
function App() {
  ...
  return (
    <div className="bg-blue-500">
      <div className='text-5xl justify-center items-center flex p-8'>
        <div>    </div><Typewriter
            onInit={(typewriter) => {
              typewriter

                .typeString("Quotes about time")

                .pauseFor(1000)
                  .deleteAll()
                .typeString("SAVE YOUR TIME")
                .deleteAll()
                .typeString("TIME FLEW")
                .deleteAll()
                .typeString("Quotes aout time")
                .start();
            }}
          /></div> 
      <div className="bg-blue-400 border-4 border-sky-500 p-3 h-28 justify-center items-center flex-col relative" >
            <div className="text-2xl justify-center items-center flex ">{paragraph}</div>

          </div>
      <button><div className="bg-blue-500 text-4xl h-screen w-full flex absolute justify-center items-center" onClick={() => {
        generate();
        problem();
